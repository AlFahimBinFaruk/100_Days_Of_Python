...
* Ex 02 : The list contains the matches in the order they are found. If no matches are found, an empty list is returned:
```bash
import re
...
* Ex 02 : You can control the number of replacements by specifying the count parameter:
```bash
import re
